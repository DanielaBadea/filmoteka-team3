 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oi(e){return{type:"value",snapshotNode:e}}function Pi(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function Di(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function Mi(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Or{trackChildChange(e){const t=e.type,n=e.childName;G("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),G(".priority"!==n,"Only non-priority child changes can be tracked.");const i=this.changeMap.get(n);if(i){const r=i.type;if("child_added"===t&&"child_removed"===r)this.changeMap.set(n,Mi(n,e.snapshotNode,i.snapshotNode));else if("child_removed"===t&&"child_added"===r)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===r)this.changeMap.set(n,Di(n,i.oldSnap));else if("child_changed"===t&&"child_added"===r)this.changeMap.set(n,Pi(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==r)throw Y("Illegal combination of changes: "+e+" occurred after "+i);this.changeMap.set(n,Mi(n,e.snapshotNode,i.oldSnap))}}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}constructor(){this.changeMap=new Map}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function As(){var e;return"undefined"!=typeof self&&(null===(e=self.location)||void 0===e?void 0:e.href)||""}function Ls(){return"http:"===Os()||"https:"===Os()}function Os(){var e;return"undefined"!=typeof self&&(null===(e=self.location)||void 0===e?void 0:e.protocol)||null}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ps(){return!("undefined"!=typeof navigator&&navigator&&"onLine"in navigator&&"boolean"==typeof navigator.onLine&&(Ls()||me()||"connection"in navigator))||navigator.onLine}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ds{get(){return Ps()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}constructor(e,t){this.shortDelay=e,this.longDelay=t,Rs(t>e,"Short delay should be less than long delay!"),this.isMobile=pe()||ge()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Al.PROVIDER_ID="phone",Al.PHONE_SIGN_IN_METHOD="phone";class Ol extends Wa{_getIdTokenResponse(e){return qa(e,this._buildIdpRequest())}_linkToIdToken(e,t){return qa(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return qa(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}constructor(e){super("custom","custom"),this.params=e}}function Pl(e){return ll(e.auth,new Ol(e),e.bypassAuthState)}function Dl(e){const{auth:t,user:n}=e;return Es(n,t,"internal-error"),al(n,new Ol(e),e.bypassAuthState)}async function Ml(e){const{auth:t,user:n}=e;return Es(n,t,"internal-error"),sl(n,new Ol(e),e.bypassAuthState)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zl{execute(){return new Promise((async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(e){this.reject(e)}}))}async onAuthEvent(e){const{urlResponse:t,sessionId:n,postBody:i,tenantId:r,error:o,type:s}=e;if(o)return void this.reject(o);const a={auth:this.auth,requestUri:t,sessionId:n,tenantId:r||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(s)(a))}catch(e){this.reject(e)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Pl;case"linkViaPopup":case"linkViaRedirect":return Ml;case"reauthViaPopup":case"reauthViaRedirect":return Dl;default:Cs(this.auth,"internal-error")}}resolve(e){Rs(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Rs(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}constructor(e,t,n,i,r=!1){this.auth=e,this.resolver=n,this.user=i,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const mc=ue("authIdTokenMaxAge")||300;let gc=null;function _c(e=Rt()){const t=Tt(e,"auth");if(t.isInitialized())return t.getImmediate();const n=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e,t){const n=Tt(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(Le(n.getOptions(),null!=t?t:{}))return e;Cs(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:fc,persistence:[Sl,ml,_l]}),i=ue("authTokenSyncURL");if(i){const e=(r=i,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>mc)return;const i=null==t?void 0:t.token;gc!==i&&(gc=i,await fetch(r,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))});!function(e,t,n){He(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,i){He(e).onIdTokenChanged(t,n,i)}(n,(t=>e(t)))}var r;const o=ae("auth");return o&&Ma(n,`http://${o}`),n}var vc,yc;vc={loadJS:e=>new Promise(((t,n)=>{const i=document.createElement("script");var r,o;i.setAttribute("src",e),i.onload=t,i.onerror=e=>{const t=Is("internal-error");t.customData=e,n(t)},i.type="text/javascript",i.charset="UTF-8",(null!==(o=null===(r=document.getElementsByTagName("head"))||void 0===r?void 0:r[0])&&void 0!==o?o:document).appendChild(i)})),gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="},Ra=vc,yc="Browser",It(new Ve("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),r=e.getProvider("app-check-internal"),{apiKey:o,authDomain:s}=n.options;Es(o&&!o.includes(":"),"invalid-api-key",{appName:n.name});const a={apiKey:o,authDomain:s,clientPlatform:yc,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Ca(yc)},l=new Na(n,i,r,a);return function(e,t){const n=(null==t?void 0:t.persistence)||[],i=(Array.isArray(n)?n:[n]).map(la);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(i,null==t?void 0:t.popupRedirectResolver)}(l,t),l}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),It(new Ve("auth-internal",(e=>{const t=Ea(e.getProvider("auth").getImmediate());return new pc(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),At("@firebase/auth","1.6.1",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}(yc)),At("@firebase/auth","1.6.1","esm2017");const bc=St({apiKey:"AIzaSyBfSnlYUdcEqahuE0nuEPgZtyc05nxjtHE",authDomain:"filmoteka-582f6.firebaseapp.com",databaseURL:"https://filmoteka-582f6-default-rtdb.firebaseio.com",projectId:"filmoteka-582f6",storageBucket:"filmoteka-582f6.appspot.com",messagingSenderId:"218771303492",appId:"1:218771303492:web:8772c72c18d03702ab6011",measurementId:"G-239H878QXK"});var wc=_c();console.log(wc),console.log("test");const xc=function(e=Rt(),t){const n=Tt(e,"database").getImmediate({identifier:t});if(!n._instanceStarted){const e=le("database");e&&function(e,t,n,i={}){(e=He(e))._checkNotDeleted("useEmulator"),e._instanceStarted&&on("Cannot call useEmulator() after instance has already been initialized.");const r=e._repoInternal;let o;if(r.repoInfo_.nodeAdmin)i.mockUserToken&&on('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new wn(wn.OWNER);else if(i.mockUserToken){const t="string"==typeof i.mockUserToken?i.mockUserToken:de(i.mockUserToken,e.app.options.projectId);o=new wn(t)}!function(e,t,n,i){e.repoInfo_=new kn(`${t}:${n}`,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams,!0),i&&(e.authTokenProvider_=i)}(r,t,n,o)}(n,...e)}return n}(bc);function kc(){email=document.getElementById("register_email").value,password=document.getElementById("register_password").value,0!=Tc(email)&&0!=Nc(password)?hl(wc,email,password).then((function(e){const t=e.user,n=(hs(xc),{email:email,last_login:Date.now()});fs(hs(xc,"users/"+t.uid),n).then((()=>{alert("User Created!!")})).catch((e=>{alert("Error creating user data: "+e.message)}))})).catch((function(e){e.code;const t=e.message;alert(t)})):alert("Email or Password is Outta Line!!")}function Cc(){email=document.getElementById("login_email").value,password=document.getElementById("login_password").value,rememberMe=document.getElementById("remember_me").checked,0!=Tc(email)&&0!=Nc(password)?dl(wc,email,password).then((function(e){wc=_c();const t=e.user.email,n=document.getElementsByClassName("btn-signOut");n.length&&n[0].classList.remove("inactive");const i=document.getElementsByClassName("btn-logIn");i.length&&i[0].classList.add("inactive"),document.querySelector("[data-modal]").classList.toggle("is-hidden"),alert("Welcome "+t)})).catch((function(e){const t=e.message;alert(t)})):alert("Email or Password is Outta Line!!")}function Ic(){var e;(e=wc,He(e).signOut()).then((()=>{const e=document.getElementsByClassName("btn-signOut");e.length&&e[0].classList.add("inactive");const t=document.getElementsByClassName("btn-logIn");t.length&&t[0].classList.remove("inactive")})).catch((e=>{const t=e.message;alert(t)}))}function Tc(e){return expression=/^[^@]+@\w+(\.\w+)+\w$/,1==expression.test(e)}function Nc(e){return!(e>6)}console.log(bc),document.addEventListener("DOMContentLoaded",(function(){const e=document.querySelector(".submit-btn[onclick='loginModal()']"),t=document.querySelector(".submit-btn[onclick='registerModal()']"),n=document.querySelector(".btn-signOut");n&&n.addEventListener("click",Ic),e&&(e.onclick=null,e.addEventListener("click",Cc)),t&&(t.onclick=null,t.addEventListener("click",kc))}));o=r("7rYDH"),s=r("5uEKZ");const Ec=document.querySelector(".fetch-cards");function Sc(){k.style.display="block",Ec.style.display="none",(0,o.getTrending)(Rc).then((e=>{l(e),(0,s.saveLocalStorage)("moviesData",e.results),k.style.display="none",Ec.style.display="block"}))}let Rc=1;Sc();const Ac=document.querySelector(".prev-btn"),Lc=document.querySelector(".next-btn");Ac.addEventListener("click",(()=>{Rc++,Sc()})),Lc.addEventListener("click",(()=>{Rc>1?(Rc--,Sc()):Lc.classList.add("disabled")})),(()=>{const e={openModalBtn:document.querySelector("[data-modal-open-js]"),closeModalBtn:document.querySelector("[data-modal-close-js]"),mondial:document.querySelector("[data-modal-js]")};function t(){e.mondial.classList.toggle("is-hidden")}e.openModalBtn.addEventListener("click",t),e.closeModalBtn.addEventListener("click",t)})();
//# sourceMappingURL=index.aff5f430.js.map
